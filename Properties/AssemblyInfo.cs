...
// これらの属性値を変更してください。
[assembly: AssemblyTitle("ジオロケータープラグイン")]
[assembly: AssemblyDescription("位置情報を測位します")]
...
[assembly: PluginName("ジオロケータープラグイン")]
[assembly: PluginDescription("位置情報を取得するための機能が用意されています")]
